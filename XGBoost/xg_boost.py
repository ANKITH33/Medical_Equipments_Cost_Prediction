...
def comprehensive_xgboost_training():
    """Train multiple XGBoost models, find best, and output submission."""
    print("=" * 80)
    print("XGBOOST REGRESSOR — AUTOMATED TRAINING & SUBMISSION")
    print("=" * 80)
                ...
                for subs in param_grid['subsample']:
                    for cols in param_grid['colsample_bytree']:
                        print(f"Training model {counter}/{total} → "
                              ...
                              f"subsample={subs}, colsample_bytree={cols}")
    ...
    print("\nRetraining best XGBoost model on FULL training data.")
    ...
    print("\nFinal submission saved as 'submission_xgboost.csv'")
...
if __name__ == "__main__":
    best_params, submission = comprehensive_xgboost_training()
