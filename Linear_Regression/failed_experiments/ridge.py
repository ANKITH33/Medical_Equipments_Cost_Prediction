...
# Define the parameter grid for alpha (the regularization strength)
# We search over a range of values on a log scale
param_grid = {
    'model__alpha': np.logspace(-7, 7, 15)  # [0.01, 0.1, 1, 10, 100, 1000]
}
